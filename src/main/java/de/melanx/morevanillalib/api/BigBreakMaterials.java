...
public enum BigBreakMaterials implements IItemTier {
    ...
    NETHERITE(LibConfigHandler.netheriteHarvestlevel.get(), ItemTier.NETHERITE.getMaxUses(), LibConfigHandler.netheriteMiningSpeed.get(), 11, -3.5F, ItemTier.NETHERITE.getEnchantability(), () -> RepairMaterialsList.netherite, "netherite", Tags.Items.STORAGE_BLOCKS_NETHERITE),
