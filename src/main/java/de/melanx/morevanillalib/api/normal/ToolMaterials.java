...
public enum ToolMaterials implements IConfigurableTier {
    ...
    ToolMaterials(int durability, double speed, float attackDamageBonus, int harvestLevel, int enchantmentValue, Supplier<Ingredient> repairIngredient, Supplier<Ingredient> craftingIngredient) {
