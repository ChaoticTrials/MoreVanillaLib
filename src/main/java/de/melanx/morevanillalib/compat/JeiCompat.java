...
public class JeiCompat implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        addValueInfoPage(registration, ModTags.Items.BONE_TOOLS.getAllElements(), "bone_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.BONE.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.COAL_TOOLS.getAllElements(), "coal_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.COAL.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.EMERALD_TOOLS.getAllElements(), "emerald_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.EMERALD.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.ENDER_TOOLS.getAllElements(), "ender_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.ENDER.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.FIERY_TOOLS.getAllElements(), "fiery_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.FIERY.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.GLOWSTONE_TOOLS.getAllElements(), "glowstone_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.GLOWSTONE.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.LAPIS_TOOLS.getAllElements(), "lapis_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.LAPIS.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.NETHER_TOOLS.getAllElements(), "nether_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.NETHER.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.OBSIDIAN_TOOLS.getAllElements(), "obsidian_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.OBSIDIAN.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.PAPER_TOOLS.getAllElements(), "paper_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.PAPER.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.PRISMARINE_TOOLS.getAllElements(), "prismarine_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.PRISMARINE.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.QUARTZ_TOOLS.getAllElements(), "quartz_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.QUARTZ.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.REDSTONE_TOOLS.getAllElements(), "redstone_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.REDSTONE.getRepairMaterial()).getName().getFormattedText());
        addValueInfoPage(registration, ModTags.Items.SLIME_TOOLS.getAllElements(), "slime_tools",
                ...
                getItemFromIngredient(BigBreakMaterials.SLIME.getRepairMaterial()).getName().getFormattedText());
